...
\title{Upravljanje robotom i kartiranje okoline u Unity 3D}   % upisati specificni naslov rada

\date{\MONTH~\the\year.}   % ne dirati - mjesec i godina ?e se upisati sami

\author{Aleks Markoviæ}  % upisati svoje ime i prezime
...
\include{Uvod}  
\include{RazradaProblema} 
\include{Hardver} 
\include{SoftverskiAlati} 
\include{Rjesenje} 
\include{Rezultati} 
\include{Zakljucak} 
...
\appendix
\include{KonfiguracijaRadneOkoline}
\include{Prilog2} 
\include{Prilog3}  
